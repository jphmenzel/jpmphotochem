...
if errest==3:
	ledpowermw=5.2		# Lower limit of LED power [mW]
elif errest==2:
	ledpowermw=5.4		# Upper limit of LED power [mW]
elif errest==1:
	ledpowermw=5.3		# Best estimate of LED power [mW]
...
while we<lambdaend:				#calculate sum of values within wavelength range for emission spectrum
	terma=math.exp((-1)*((((we)-341.6736)**2)/(2*(2.57945)**2)))	#determine emission spectrum values at wavelength we
...
sheet.cell(row=1, column=4).value='Simulation with 343 nm LED, full mixing.'	
