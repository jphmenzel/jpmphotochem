...
targetconversion=eval(input('Enter the target conversion (e.g. 97) [%]:'))
...
sheet.cell(row=r, column=4).value='number of pulses'	# write top cell 6
...
sheet.cell(row=5, column=5).value='Input: n reactant A, PTP (mmol)'
nrap=nra*1000
sheet.cell(row=5, column=6).value=nrap
sheet.cell(row=6, column=5).value='Input: n reactant C, NEM (mmol)'
nrcp=nrc*1000
sheet.cell(row=6, column=6).value=nrcp
sheet.cell(row=7, column=5).value='Input: n reactant B, MPE (mmol)'
nrap=nra*1000
